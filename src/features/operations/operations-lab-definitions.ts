...
const integratedOperationsTopology: ReturnType<typeof lineTopology> = {
  ...
  nodes: [
    ...
    { id: 'integrated-dns1', label: 'DNS1', kind: 'server', detail: 'NAME SERVICE', role: 'Stores the office service A record and answers the modeled lookup.', compact: { x: 50, y: 61 }, regular: { x: 88, y: 34 }, wide: { x: 89, y: 34 } },
