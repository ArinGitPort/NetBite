...
const styles = StyleSheet.create({
  ...
  node: { position: 'absolute', width: NODE_WIDTH, minHeight: 104, marginLeft: -(NODE_WIDTH / 2), marginTop: -52, padding: 4, justifyContent: 'center', alignItems: 'center', borderWidth: 1, borderColor: Palette.border, backgroundColor: Palette.background }, nodeActive: { borderColor: Palette.green }, nodeFailed: { borderColor: Palette.danger }, nodeSelected: { borderColor: Palette.orange, backgroundColor: Palette.orangeSoft }, server: { width: 52, height: 52 }, nodeLabel: { color: Palette.text, textAlign: 'center', fontFamily: Fonts.semibold }, nodeDetail: { color: Palette.textMuted, textAlign: 'center' },
  links: { minWidth: 0, gap: Space.sm, padding: Space.sm, borderWidth: 1, borderColor: Palette.border }, connection: { minWidth: 0, gap: Space.xs, padding: Space.sm, borderWidth: 1, borderColor: Palette.border, backgroundColor: Palette.background }, connectionNumber: { color: Palette.orange }, connectionEndpoints: { minWidth: 0, flexDirection: 'row', alignItems: 'center', gap: Space.sm }, endpoint: { flex: 1, minWidth: 0, gap: 2 }, endpointRight: { alignItems: 'flex-end' }, connectionLine: { width: 24, height: 2, backgroundColor: Palette.green }, connected: { color: Palette.green, textAlign: 'center' }, inspector: { minWidth: 0, gap: Space.sm, padding: Space.md, borderWidth: 1, borderColor: Palette.green, backgroundColor: Palette.surface }, inspectorHeading: { minWidth: 0, flexDirection: 'row', alignItems: 'center', gap: Space.sm }, inspectorCopy: { flex: 1, minWidth: 0, gap: Space.xs }, state: { color: Palette.text, padding: Space.sm, borderWidth: 1, borderColor: Palette.border }, stateAttention: { color: Palette.orange, borderColor: Palette.orange }, trace: { color: Palette.orange, borderLeftWidth: 2, borderLeftColor: Palette.orange, paddingLeft: Space.sm },
});
