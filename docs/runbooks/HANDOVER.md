...
- `docs/product/CURRICULUM.md` has been reviewed and rewritten into one consistent learning sequence.
...
```text
AGENTS.md
docs/runbooks/AI_DEVELOPER_GUIDE.md
docs/standards/CHAPTER1.md
docs/standards/CONTENT_GUIDE.md
docs/product/GAME_DESIGN.md
docs/standards/NETWORK_SCOPE.md
docs/standards/THEME.md
```
