...
for (const platform of ['android', 'web']) {
  ...
  const result = spawnSync(process.execPath, [join(root, 'node_modules', 'expo', 'bin', 'cli'), 'export', '--platform', platform, '--output-dir', output], { cwd: root, encoding: 'utf8', timeout: 180_000 });
